...
def main():
    ...
    if choice == 'Forecast':
        ...
        if st.button("Predict"):
            ...
            st.success(f'The profit for next {year} years in SGB is {value_1}%.'.format(year, value_1))
            st.success(f'The profit for {year} years in SBI Bond is {value_3}%'.format(year,    value_3))
            st.success(f'The profit for {year} years in IRFC Bond is {value_4}%'.format(year,   value_4))
            compare = {'Sovereign Gold Bond': value_1, 'SBI Life (Unit II Regular) - Bond Fund': value_3, 'Indian Railway Finance Corporation': value_4}
            ...
            plot1.columns = ['Sovereign Gold Bond', 'SBI Life (Unit II Regular) - Bond Fund', 'Indian Railway Finance Corporation']
            st.line_chart(plot1)
